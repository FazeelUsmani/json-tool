...
- [x] **Schema inference exports JSON Schema, TS, Zod from a 1MB JSON** *(2026-05-22 W4-Mon, commits f4a4bac → 7efd062: walker + sampler + JSON Schema / TS / Zod emitters + worker + host + UI tab strip with Tree/Schema + sub-tabs. ~85 tests across IR walk, sampling, 3 emitters. JSON Schema browser-verified on telemetry-100.json; TS/Zod sub-tabs + 1MB-scale browser verify still pending.)*
