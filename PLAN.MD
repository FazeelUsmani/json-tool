...
- [ ] 500MB JSON loads in <60s with progress bar, can navigate spine, search works *(parser is architecture-ready; untested at 500MB; no progress bar yet — depends on search slow path scope, task #73)*
